...
/**
 * strtow - function that separates a string to words
...
/**
 * is_delim - function that checks delimitor char
...
/**
 * get_word_count - function that gets the word count
...
/**
 * get_next_word - function that gets the next word
