...
/**
 * monty_rotr - function that rotates the bottom value
...
/**
 * monty_stack - function that converts a queue to a stack
 * @stack: A pointer to the top mode
 * @line_number: The current working line
 */
...
/**
 * monty_queue - function that converts a stack to a queue
